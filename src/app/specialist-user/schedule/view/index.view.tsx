      ...
      <div className="flex-1 overflow-y-auto flex flex-col gap-4 md:gap-6">
        ...
        <div className="w-full">
          ...
          <div className="hidden md:flex flex-row items-center justify-between gap-4 mb-6 w-full">
            ...
            <div
              className="bg-slate-200/60 p-1 rounded-xl flex gap-1 text-xs font-semibold shadow-inner w-full md:w-auto"
              role="tablist"
              aria-label="Modo de visualização"
            >
              <button
                onClick={() => onViewModeChange("semana")}
                className={`px-3 py-2 rounded-lg cursor-pointer transition-all flex-1 md:flex-initial ${viewMode === "semana" ? "bg-white text-blue-600 shadow-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" : "text-slate-500 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-400"}`}
                role="tab"
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg transition-all flex-1 md:flex-initial cursor-pointer ${viewMode === "dia" ? "bg-white text-blue-600 shadow-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" : "text-slate-500 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-400"}`}
                role="tab"
